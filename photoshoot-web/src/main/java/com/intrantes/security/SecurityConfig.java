package com.intrantes.security;

import com.intrantes.service.UserDetailsServiceImpl;
...
//    InMemoryAuthenticationProvider
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.exceptionHandling().accessDeniedPage("/error/403")
                ...
                //注销客户端,放在CAS_FILTER之前
                .addFilterBefore(singleSignOutFilter(), CasAuthenticationFilter.class)
                //注销服务器端,此处把logout重新写了下,放在Spring Security的登出过滤器之前
                ...
                .authorizeRequests()
                //对于登录路径不进行拦截
                .antMatchers("/templates/photoshoot_default.html").permitAll()
...
//                    .loginPage("/templates/photoshoot_default.html")//登录页面的访问路径
                ...
                //登录失败后跳转的路径
                .failureUrl("/templates/failure.html")
                //登录成功后默认跳转的路径
                .defaultSuccessUrl("/templates/user_default.html")
...
//        包装了一个普通的UserDetailsService实现,根据Authentication对象中包含的用户名来检索UserDetails 对象
